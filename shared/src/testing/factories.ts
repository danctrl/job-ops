...
export const createJob = (overrides: Partial<Job> = {}): Job => ({
  ...
  coverLetterFreshness: "missing",
  coverLetterFingerprint: null,
...
export const createAppSettings = (
  ...
  resumeSkills: {
    value: { maxKeywords: 22, lockedGroupIds: [], excludedGroupIds: [] },
    default: { maxKeywords: 22, lockedGroupIds: [], excludedGroupIds: [] },
    override: null,
  },
  tailoringFeatures: {
    value: {
  ...
  coverLetterPromptTemplate: {
    value: getDefaultPromptTemplate("coverLetterPromptTemplate"),
    default: getDefaultPromptTemplate("coverLetterPromptTemplate"),
    override: null,
  },
  resumeTranslationPromptTemplate: {
    value: getDefaultPromptTemplate("resumeTranslationPromptTemplate"),
    default: getDefaultPromptTemplate("resumeTranslationPromptTemplate"),
    override: null,
  },
  searchCities: {
    value: "",
